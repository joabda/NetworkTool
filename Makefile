...
$(EXEC): main.o Network.o Host.o Port.o DataBase.o Algorithm.o
	$(CC) -o $@ $^ -L/usr/lib -lsqlite3

main.o: main.cpp Network.h
	$(CC) $(CXXFLAGS) -o $@ -c $< 

Network.o: Network.cpp Network.h Host.h Algorithm.h
	$(CC) $(CXXFLAGS) -o $@ -c $<
...
Algorithm.o: Algorithm.cpp Algorithm.h Network.h Host.o
	$(CC) $(CXXFLAGS) -o $@ -c $<
